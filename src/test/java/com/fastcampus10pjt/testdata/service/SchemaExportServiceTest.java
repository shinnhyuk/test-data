...
class SchemaExportServiceTest {
    ...
    @Test
    void givenExportFileTypeAndSchemaDtoAndRowCount_whenExporting_thenMarkEntityExportedAndReturnsRileFormattedString() {
        // given
        ExportFileType exportFileType = ExportFileType.CSV;
        TableSchemaDto dto = TableSchemaDto.of("test_schema", "shinnhyuk", null, null);
        int rowCount = 5;
    ...
    @DisplayName("입력 파라미터 중에 유저 식별 정보가 없으면, 스키마 테이블 조회를 시도하지 않아야 한다.")
    @Test
